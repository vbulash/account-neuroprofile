							...
							<div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-body-extra-light">
								...
								<form method="POST" action="{{ route('password.email') }}">
									...
									<div class="mb-4 text-sm text-gray-600">
										Забыли пароль? Нет проблем. Введите адрес электронной почты пользователя платформы
										&laquo;{{ env('APP_NAME') }}&raquo;, на которую мы пришлем ссылку сброса пароля, что позволит ввести вам новый
										пароль
									</div>
