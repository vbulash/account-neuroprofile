...
@section('js')
	...
	<script src="{{ asset('js/lib/jquery.min.js', true) }}"></script>
	...
	<script src="{{ asset('js/plugins/datatables-buttons-bs5/js/buttons.bootstrap5.min.js', true) }}"></script>
	<script src="{{ asset('js/plugins/datatables-buttons-jszip/jszip.min.js', true) }}"></script>
	<script src="{{ asset('js/plugins/datatables-buttons-pdfmake/pdfmake.min.js', true) }}"></script>
	<script src="{{ asset('js/plugins/datatables-buttons-pdfmake/vfs_fonts.js', true) }}"></script>
	<script src="{{ asset('js/plugins/datatables-buttons/buttons.print.min.js', true) }}"></script>
	<script src="{{ asset('js/plugins/datatables-buttons/buttons.html5.min.js', true) }}"></script>
